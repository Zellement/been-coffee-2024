<template>
    <div class="grid-layout">
        <main class="content col-span-10 col-start-2">
            ...
            <hr />
            <p>
                Todays date is (full date converter):
                {{ fullDateConverter(new Date()) }}
            </p>
            <p>
                Todays date is (short date converter):
                {{ shortDateConverter(new Date()) }}
            </p>
            <hr />
            <p>
            ...
            <p>
                {{
                    truncateString(
                        'This is a truncated string at 200 characters. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras ultrices feugiat lorem non rutrum. Fusce blandit a mi vitae commodo. Praesent venenatis non purus sit amet mattis. Curabitur a suscipit tellus. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Nulla nec ultrices metus. Suspendisse potenti. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Cras libero felis, mollis ac suscipit et, scelerisque sed augue. Donec id elit bibendum, semper dolor non, faucibus sem.',
                        200
                    )
                }}
            </p>
...
const { toTitleCase, truncateString } = useStringUtils()
